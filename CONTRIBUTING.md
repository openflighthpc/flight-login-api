# Contributing to flight-login

:+1::tada: Thanks for taking the time to contribute! :tada::+1:

You want to contribute to flight-login? Welcome! Please read this
...
You can help flight-login by helping others who use it and need support.

## Analyse Issues

Analysing issue reports can be a lot of effort. Any help is welcome!
Go to [the GitHub issue tracker](https://github.com/openflighthpc/flight-login-api/issues?state=open)
...
If you find a bug - behaviour of flight-login code or documentation
...
[GitHub issue tracker for flight-login](https://github.com/openflighthpc/flight-login-api/issues/new)
to report the issue.
...
We want to improve the quality of flight-login and good bug reports are
...
flight-login is Open Source and comes without warranty.
...
flight-login in order to fix bugs or to implement new features.
...
2. **Not all proposed contributions can be accepted**. Some features
   ...
   the overall direction of flight-login and really improve it. The more
...
applied to flight-login itself.

In particular you need to agree to the Contributor License Agreement,
which can be [found
here](https://www.clahub.com/agreements/openflighthpc/flight-login-api). This
...
8. Wait for our code review and approval, possibly enhancing your
   change on request.
    - Note that the flight-login developers also have their regular
