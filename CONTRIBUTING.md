# Contributing to flight-web-auth

:+1::tada: Thanks for taking the time to contribute! :tada::+1:

You want to contribute to flight-web-auth? Welcome! Please read this
...
You can help flight-web-auth by helping others who use it and need support.

## Analyse Issues

Analysing issue reports can be a lot of effort. Any help is welcome!
Go to [the GitHub issue tracker](https://github.com/openflighthpc/flight-web-auth-api/issues?state=open)
...
If you find a bug - behaviour of flight-web-auth code or documentation
...
[GitHub issue tracker for flight-web-auth](https://github.com/openflighthpc/flight-web-auth-api/issues/new)
to report the issue.
...
We want to improve the quality of flight-web-auth and good bug reports are
...
flight-web-auth is Open Source and comes without warranty.
...
flight-web-auth in order to fix bugs or to implement new features.
...
2. **Not all proposed contributions can be accepted**. Some features
   ...
   the overall direction of flight-web-auth and really improve it. The more
...
applied to flight-web-auth itself.

In particular you need to agree to the Contributor License Agreement,
which can be [found
here](https://www.clahub.com/agreements/openflighthpc/flight-web-auth-api). This
...
8. Wait for our code review and approval, possibly enhancing your
   change on request.
    - Note that the flight-web-auth developers also have their regular
